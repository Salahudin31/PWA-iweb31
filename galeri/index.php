		...
		<div class="row no-gutters">
			<div class="col-lg-8 col-md-8 col-12">
				...
				<div class="row no-gutters mb-2">
					...
					<div class="col-md-4 col-sm-4 col-6 filter <?php echo $kategori_get['nm_kategori'];?>">
					...
					<div class="col-md-4 col-sm-4 col-6 filter <?php echo $kategori_get['kategori_tp'];?>">
