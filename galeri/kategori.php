	...
	<div class="p-1">
		<div class="row no-gutters">
			<div class="col-lg-8 col-md-8 col-12">
				...
				<?php $kd_kategori = $_GET['kategori']; $kategoris = $kategori->select_kategori_kd($kd_kategori); $kategori_tp= $kategoriArtikel->select_kA_kd($kategoris['nm_kategori']);?>				
				<div class='link-kat'><a class='btn active disable'><?php echo $kategoris['nm_kategori']?></a>
				...
				<div class="row no-gutters">
					...
					<?php } 
					foreach ($kategori_tp as $kategori_value) {
					$artikel_get_kategori=$artikel->select_artikel_kategoriartikel($kategori_value['kode_kategori']);
					foreach ($artikel_get_kategori as $artikel_value) { ?>
					<div class="col-md-4 col-sm-4 col-6">
