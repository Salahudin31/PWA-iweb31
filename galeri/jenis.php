...
$kd_jenis=$_GET[ 'jenis_kd']; $artikel_get_jenis=$artikel->select_artikel_jenis($kd_jenis);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
	...
	<title>Iweb31 - Jenis Artikel</title>
	...
	<div class="p-1">
		<div class="row no-gutters">
			<div class="col-lg-8 col-md-8 col-12">
				...
				<?php $jeniss = $jenis->select_jenis_kd($kd_jenis); ?>
				<div class='link-kat'><a class='btn active disable'><?php echo $jeniss['nm_jenis'];?></a>
